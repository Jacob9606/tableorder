...
COMMENT ON TABLE "public"."Cart" IS 'Customer''s unique cart';
...
CREATE TABLE IF NOT EXISTS "public"."items_duplicate" (
...
ALTER TABLE "public"."items_duplicate" OWNER TO "postgres";

COMMENT ON TABLE "public"."items_duplicate" IS 'This is a duplicate of items';
...
CREATE TABLE IF NOT EXISTS "public"."orders" (
    "id" "uuid" DEFAULT "extensions"."uuid_generate_v4"(),
    "tableid" "uuid" DEFAULT "extensions"."uuid_generate_v4"(),
    "item" "text",
    "price" double precision,
...
ALTER TABLE ONLY "public"."items_duplicate"
    ADD CONSTRAINT "items_duplicate_pkey" PRIMARY KEY ("id");
...
GRANT ALL ON TABLE "public"."items_duplicate" TO "anon";
GRANT ALL ON TABLE "public"."items_duplicate" TO "authenticated";
GRANT ALL ON TABLE "public"."items_duplicate" TO "service_role";
